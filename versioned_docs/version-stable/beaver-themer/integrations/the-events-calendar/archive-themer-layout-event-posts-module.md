...
The Event Posts module has all of the [regular Posts module settings](/beaver-builder/modules/posts/posts.md) on the **Layout** tab plus an extra **Events Calendar** section, which lets you show or hide the **Event date** (and time) and the **Event address**.
