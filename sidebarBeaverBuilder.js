      ...
      items: [
        {
          ...
          items: [
            ...
            "account/license/activations",
            "account/license/view-activate",
            "account/license/renew",
            "account/license/downgrade",
            "account/license/upgrade",
            "account/license/cancel",
            "account/license/expiry",
      ...
      items: [
        {
          ...
          link: {
            type: "doc",
            id: "layouts/templates/index",
          },
          items: [
            "layouts/templates/prebuilt-templates",
            "layouts/templates/saved-templates",
            "layouts/templates/theme-template-authors",
            "layouts/templates/template-site",
          ],
        },
        {
          type: "category",
        ...
        },
        {
          ...
          items: [
            "layouts/modules/accordion",
            "layouts/modules/acf-block",
            "layouts/modules/audio",
            "layouts/modules/bigcommerce",
            "layouts/modules/box",
            "layouts/modules/button",
            "layouts/modules/button-group",
            "layouts/modules/callout",
            "layouts/modules/contact-form",
            "layouts/modules/content-slider",
            "layouts/modules/countdown",
            "layouts/modules/cta",
            "layouts/modules/gallery",
            "layouts/modules/heading",
            "layouts/modules/html",
            "layouts/modules/icon",
            "layouts/modules/icon-group",
            "layouts/modules/index",
            "layouts/modules/list",
            "layouts/modules/login-form",
            "layouts/modules/loop",
            "layouts/modules/map",
            "layouts/modules/menu",
            "layouts/modules/north-commerce",
            "layouts/modules/numbers",
            "layouts/modules/photo",
            "layouts/modules/popup",
            "layouts/modules/post-carousel",
            "layouts/modules/post-grid",
            "layouts/modules/post-slider",
            "layouts/modules/pricing-table",
            "layouts/modules/rich-text",
            "layouts/modules/search",
            ...
            "layouts/modules/subscribe-form",
            "layouts/modules/tabs",
            "layouts/modules/testimonials",
            "layouts/modules/video",
        ...
        },
        {
          ...
          items: [
            ...
            "layouts/advanced-tab/custom-attributes",
