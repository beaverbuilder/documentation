...
The Icon Group module is designed for multiple icons displayed together. If you only need a single icon, use the [Icon](/beaver-builder/layouts/modules/icon.mdx) module instead.
:::
