...
The Button Group module is designed for multiple buttons displayed together. If you only need a single button, use the [Button](/beaver-builder/layouts/modules/button.mdx) module instead.
:::
