...
5. Instead of or in addition to the standard [generated WordPress index and archive pages](/beaver-builder/layouts/post-layouts/generated-wordpress-archives-versus-beaver-builder-layouts.md), you can use any of the Posts modules in Beaver Builder layouts to create lists of posts on static pages. If you use a Posts module instead of a generated archive, it may change [how you configure WordPress to handle your blog settings](/bb-theme/defaults-for-layouts-content/blog-settings/configure-how-wordpress-handles-your-blog).
